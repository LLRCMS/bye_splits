...
CfgPaths = {
    ...
    'cluster_app': os.path.join(parent_dir, 'bye_splits/plot/display_clusters/config.yaml'),
    'cluster_size': os.path.join(parent_dir, 'bye_splits/scripts/cl_size_params.yaml')
}